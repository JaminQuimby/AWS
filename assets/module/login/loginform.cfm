...
options={"e":""+$('##j_username').val()+"","r":"","p":""}
$.extend(true,options,params);

if($("##a_password").val()!=$("##b_password").val()){alert('Your Password does not match.')}
if(!isEmail(''+$("##j_username").val()+'')){alert('Your email address is not valid.')}

if($("##a_password").val()==$("##b_password").val() && isEmail($("##j_username").val())) {c_password=$("##a_password").val()}
...
},hash_password:function(params){
options={"p1":""+$('##a_password').val()+"","p2":""+$('##b_password').val()+""}
$.extend(true,options,params);

p1= options['p1'];
p2= options['p2'];
if(p1==p2){
_run.reset_password({"r":"#URL.r#","e":"#URL.e#","p":""+p1+""})
}
}
...
<div class="message">
 ...
 <input name="j_username" type="email" id="j_username" value="#URL.e#" placeholder="&##xf0e0;  Email Address" >

 <div>
 <label for="a_password">New Password:</label>

 <input type="password" id="a_password" placeholder="&##xf023;  Password" max="20">
 </div>
 <label for="b_password">Verify Password:</label>

 <input type="password" id="b_password" placeholder="&##xf023;  Password" max="20">

 <div class="buttonbox"><input type="button" value="Save" onClick='_run.hash_password();'></div>
</div> 
<cfelse>
<H2>Please Log In</H2>
<div class="message">
