...
<ul class="splash">
  <li>
	...
	<ul class="group1">
		<li>Payroll &amp;Taxes</li>
		<li><a href="AWS/_payrolltaxes/reports/payrollchecks_report.cfm">Payroll Checks Reports</a></li>
		<li><a href="AWS/_payrolltaxes/reports/payrolltaxes_report.cfm">Payroll Taxes Reports</a></li>
		<li><a href="AWS/_payrolltaxes/reports/otherfilings_report.cfm">Other Filings Reports</a></li>
	...
	<ul class="group2">
		...
		<li><a href="AWS/_accountingservices/reports/businessformation_report.cfm">Business Formation Reports</a></li>
		<li><a href="AWS/_accountingservices/reports/acctingconsulting_report.cfm">Accounting &amp; Consulting Reports</a></li>
		<li><a href="AWS/_accountingservices/reports/financialstatements_report.cfm">Financial Statements Reports</a></li>
	...
	<ul class="group3">
		<li>Taxation</li>
		<li><a href="AWS/_taxation/reports/financialtaxplanning_report.cfm">Financial &amp Tax Planning Reports</a></li>
		<li><a href="AWS/_taxation/reports/notices_report.cfm">Notices Reports</a></li>
		<li><a href="AWS/_taxation/reports/powerofattorney_report.cfm">Power of Attorney Reports</a></li>
		<li><a href="AWS/_taxation/reports/taxreturns_report.cfm">Tax Returns Reports</a></li>
	...
	<ul class="group4">
		...
		<li><a href="AWS/_clientmanagement/reports/administrativetasks_report.cfm">Administrative Tasks Reports</a></li>
		<li><a href="AWS/_clientmanagement/reports/communications_report.cfm">Communications Reports</a></li>
		<li><a href="AWS/_clientmanagement/reports/clientmaintenance_report.cfm">Client Maintenance Reports</a></li>
	...
	<ul class="group5">
		...
		<li><a href="AWS/_PracticeManagement/workinprogress.cfm">Work in Progress</a></li>
