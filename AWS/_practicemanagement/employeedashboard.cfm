...
<div>
<div><label for="g0_filter">Employee Filter</label><input id="g0_filter" onBlur="_grid1();" onKeyPress="if(event.keyCode==13){_grid1();}"/></div>
<!--- Entrace Grid --->
...
<div>
<div><label for="g2_1_filter">Payroll Checks Filter</label><input id="g2_1_filter" onBlur="_grid2_1();" onKeyPress="if(event.keyCode==13){_grid2_1();}"/></div>
...
<div>
<div><label for="g2_2_filter">Payroll Taxes Filter</label><input id="g2_2_filter" onBlur="_grid2_2();" onKeyPress="if(event.keyCode==13){_grid2_2();}"/></div>
...
<div>
<div><label for="g2_3_filter">Other Filings Filter</label><input id="g2_3_filter" onBlur="_grid2_3();" onKeyPress="if(event.keyCode==13){_grid2_3();}"/></div>
...
<div id="group3" class="gf-checkbox">
 <h3>Accounting & Consulting</h3><div></div>
	...
	<h4 onClick='_grid3_1();'>Business Formation</h4>
		<div>
		<div><label for="g3_1_filter">Business Formation Filter</label><input id="g3_1_filter" onBlur="_grid3_1();" onKeyPress="if(event.keyCode==13){_grid3_1();}"/></div>
	...
	<h4 onClick='_grid3_2();'>Accounting & Consulting</h4>
		<div>
		<div><label for="g3_2_filter">Accounting & Consulting Filter</label><input id="g3_2_filter" onBlur="_grid3_2();" onKeyPress="if(event.keyCode==13){_grid3_2();}"/></div>
	...
	<h4 onClick='_grid3_3();'>Financial Statements</h4>
		<div>
		<div><label for="g3_3_filter">Financial Statements Filter</label><input id="g3_3_filter" onBlur="_grid3_3();" onKeyPress="if(event.keyCode==13){_grid3_3();}"/></div>
...
<div id="group4" class="gf-checkbox">
 <h3>Notices</h3><div></div>	
	...
	<h4 onClick='_grid4_1();'>Notices</h4>
		<div>
		<div><label for="g4_1_filter">Notices Filter</label><input id="g4_1_filter" onBlur="_grid4_1();" onKeyPress="if(event.keyCode==13){_grid4_1();}"/></div>
	...
	<h4 onClick='_grid4_2();'>Notices For Review</h4>
		<div>
		<div><label for="g4_2_filter">Notices For Review Filter</label><input id="g4_2_filter" onBlur="_grid4_2();" onKeyPress="if(event.keyCode==13){_grid4_2();}"/></div>
...
<div id="group5" class="gf-checkbox">	
 <h3>Taxation</h3><div></div>
	...
	<h4 onClick='_grid5_1();'>Data Entry</h4>
		<div>
		<div><label for="g5_1_filter">Tax Return Data Entry Filter</label><input id="g5_1_filter" onBlur="_grid5_1();" onKeyPress="if(event.keyCode==13){_grid5_1();}"/></div>
	...
	<h4 onClick='_grid5_2();'>Missing Information</h4>
		<div>
		<div><label for="g5_2_filter">Tax Return Missing Information Filter</label><input id="g5_2_filter" onBlur="_grid5_2();" onKeyPress="if(event.keyCode==13){_grid5_2();}"/></div>
	...
	<h4 onClick='_grid5_3();'>Ready for Review</h4>
		<div>
		<div><label for="g5_3_filter">Tax Returns for Review Filter</label><input id="g5_3_filter" onBlur="_grid5_3();" onKeyPress="if(event.keyCode==13){_grid5_3();}"/></div>
	...
	<h4 onClick='_grid5_4();'>Assembly &amp; Delivery</h4>
		<div>
		<div><label for="g5_4_filter">Tax Returns Assembly &amp; Delivery Filter</label><input id="g5_4_filter" onBlur="_grid5_4();" onKeyPress="if(event.keyCode==13){_grid5_4();}"/></div>
	...
	<h4 onClick='_grid5_5();'>State Tax Returns</h4>
		<div>
		<div><label for="g5_5_filter">State Tax Returns Filter</label><input id="g5_5_filter" onBlur="_grid5_5();" onKeyPress="if(event.keyCode==13){_grid5_5();}"/></div>
	...
	<h4 onClick='_grid5_6();'>Financial Tax Planning</h4>
		<div>
		<div><label for="g5_6_filter">Financial Tax Planning Filter</label><input id="g5_6_filter" onBlur="_grid5_6();" onKeyPress="if(event.keyCode==13){_grid5_6();}"/></div>
...
<div id="group6" class="gf-checkbox">
 <h3>Client Management</h3><div></div>
	...
	<h4 onClick='_grid6_1();'>Administrative Tasks</h4>
		<div>
		<div><label for="g6_1_filter">Administratice Tasks Filter</label><input id="g6_1_filter" onBlur="_grid6_1();" onKeyPress="if(event.keyCode==13){_grid6_1();}"/></div>
	...
	<h4 onClick='_grid6_2();'>Communications</h4>
		<div>
		<div><label for="g6_2_filter">Communications Filter</label><input id="g6_2_filter" onBlur="_grid6_2();" onKeyPress="if(event.keyCode==13){_grid6_2();}"/></div>
	...
	<h4 onClick='_grid6_3();'>Document Tracking Log</h4>
		<div>
		<div><label for="g6_3_filter">Document Tracking Log Filter</label><input id="g6_3_filter" onBlur="_grid6_3();" onKeyPress="if(event.keyCode==13){_grid6_3();}"/></div>
...
<div id="group7" class="gf-checkbox">
        <h3>All Modules</h3>
 		<div>
 		<div><label for="g7_filter">All Modules Filter</label><input id="g7_filter" onBlur="_grid7();" onKeyPress="if(event.keyCode==13){_grid7();}"/></div>
