...
<h3>General</h3>
<div>
<div><label for="g1_selectLabel" >Select Label</label><input type="text" id="g1_selectLabel" class="readonly" readonly="readonly"/></div>
<div><label for="g1_selectDescription">Select Description</label><textarea  id="g1_selectDescription" class="readonly" cols="4" rows="4" readonly="readonly"></textarea></div>
</div>
</div>
<!--- OPTIONS --->
