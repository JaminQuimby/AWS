...
_grid1=function(){_jGrid({
	...
	"fields":{USER_ID:{key:true,list:false,edit:false}
			,SI_NAME:{title:'User'}
			,M_PAYROLLTAXES:{title:'Payroll Taxes',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			,M_ACCOUNTINGSERVICES:{title:'Accounting Services',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			,M_TAXATION:{title:'Taxation',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			,M_CLIENTMANAGEMENT:{title:'Client Management',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			,M_MAINTENANCE:{title:'Maintenance',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			,G_DELETE:{title:'Delete',type:'checkbox',values:{ '0' : 'No', '1' : 'Yes' }}
			},
	"method":"f_lookupData",
