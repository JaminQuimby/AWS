...
_grid3=function(){_jGrid({
	...
	,CO_CREDITHOLD:{title:'Credit Hold'}
	,CO_FEES:{title:'Fees'}
	,CO_PAID:{title:'Paid'}
...
_grid11=function(){_jGrid({
	...
	"fields":{PT_ID:{key:true,list:false,edit:false}
			...
			,PT_LASTPAY:{title:'Last Pay'}
			,PT_DUEDATE:{title:'Due Date'}
			,PT_DELIVERY_DATECOMPLETED:{title:'Completed'}
			},
	"method":"f_lookupData",
...
_grid12=function(){_jGrid({
	...
	"fields":{TR_ID:{key:true,list:false,edit:false}
			,CLIENT_NAME:{title:'Client Name'}
			,TR_TAXYEAR:{title:'Year'}
			,TR_TAXFORM:{title:'Form'}
			,TR_1_INFORMATIONRECEIVED:{title:'Information Received'}
			,TR_3_PRIORFEES:{title:'Prior Fees'}
			,TR_4_DROPOFFAPPOINTMENT:{title:'Drop Off Appointment'}
			,TR_4_PICKUPAPPOINTMENT:{title:'Pick UP Appointment'}
			,TR_1_MISSINGINFORECEIVED:{title:'Missing Information Received'}
			,TR_1_DUEDATE:{title:'Due Date'}
			,TR_1_REVIEWEDWITHNOTES:{title:'Reviewed With Notes'}
			},
	"method":"f_lookupData",
