...
<div><label for="g1_year"><i class="fa fa-lock link" onClick="_schk('g1_year')"></i> Year</label><select id="g1_year" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_years"><cfif optionvalue_id neq year(now())><option value="#optionvalue_id#">#optionname#</option><cfelse><option value="#optionvalue_id#" selected="selected">#optionname#</option></cfif></cfoutput></select></div>
...
<div><label for="g1_esttime">Estimated Time</label><input type="text" id="g1_esttime"  maxlength="4" placeholder="0" /></div>
<div><label for="g1_inforeceived">Information Received</label><input type="text"id="g1_inforeceived" class="date"/></div>
...
<div><label for="g1_deliverymethod">Delivery Method</label><select id="g1_deliverymethod" ><option value="0">&nbsp;</option><cfoutput query="global_delivery"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
	...
	<div>
		...
		<div><label for="g1_g7_estimatedtime">Estimated Time</label><input type="text"  maxlength="4" placeholder="0" id="g1_g7_estimatedtime"  /></div>
	</div>
	...
	<div>
		...
		<div><label for="g1_g8_estimatedtime">Estimated Time</label><input type="text"  maxlength="4" placeholder="0" id="g1_g8_estimatedtime" /></div>
	</div>
	...
	<div>
		...
		<div><label for="g1_g9_estimatedtime">Estimated Time</label><input type="text"  maxlength="4" placeholder="0" id="g1_g9_estimatedtime"  /></div>
	</div>
	...
	<div>
		...
		<div><label for="g1_g10_estimatedtime">Estimated Time</label><input type="text"  maxlength="4" placeholder="0" id="g1_g10_estimatedtime"  /></div>
	</div>
	...
	<div>
		...
		<div><label for="g1_g11_estimatedtime">Estimated Time</label><input type="text"  maxlength="4" placeholder="0" id="g1_g11_estimatedtime"  /></div>
	</div>
</div>
