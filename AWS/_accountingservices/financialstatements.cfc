...
,[fdss_status]
,[fdss_subtask]
FROM[financialdatastatus_status]
...
,[fds_esttime]=<cfqueryparam value="#j.DATA[1][7]#"/>
,[fds_fees]=<cfqueryparam value="#j.DATA[1][8]#"/>
...
<cfif j.DATA[1][1] eq "0">
<cfquery name="fquery" datasource="AWS">
INSERT INTO[FINANCIALDATASTATUS_STATUS]([fds_id]
,[fdss_assignedto]
,[fdss_completed]
,[fdss_duedate]
,[fdss_notes]
...
<cfif #j.DATA[1][1]# neq "0">
<cfquery name="fquery" datasource="AWS">
UPDATE[FINANCIALDATASTATUS_STATUS]
...
,[fdss_duedate]=<cfqueryparam value="#j.DATA[1][5]#"/>
