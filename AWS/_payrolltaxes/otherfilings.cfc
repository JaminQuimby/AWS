...
,[of_obtaininfo_datecompleted]=FORMAT(of_obtaininfo_datecompleted,'#Session.localization.formatdate#') 
...
,[of_preparation_datecompleted]=FORMAT(of_preparation_datecompleted,'#Session.localization.formatdate#') 
...
,[of_review_datecompleted]=FORMAT(of_review_datecompleted,'#Session.localization.formatdate#') 
,[of_review_esttime]
FROM[otherfilings]
WHERE[of_id]=<cfqueryparam value="#ARGUMENTS.ID#"/>
</cfquery>
...
,[of_assembly_datecompleted]=FORMAT(of_assembly_datecompleted,'#Session.localization.formatdate#') 
,[of_assembly_esttime]
FROM[otherfilings]
WHERE[of_id]=<cfqueryparam value="#ARGUMENTS.ID#"/>
</cfquery>
...
,[of_delivery_datecompleted]=FORMAT(of_delivery_datecompleted,'#Session.localization.formatdate#') 
,[of_delivery_esttime]
FROM[otherfilings]
WHERE[of_id]=<cfqueryparam value="#ARGUMENTS.ID#"/>
</cfquery>
...
<cfquery datasource="#Session.organization.name#" name="fQuery">
SELECT[of_obtaininfo_datecompleted]=FORMAT(of_obtaininfo_datecompleted,'#Session.localization.formatdate#')
...
,[of_assignedto]=<cfqueryparam value="#j.DATA[1][3]#" null="#LEN(j.DATA[1][3]) eq 0#"/>
,[of_deliverymethod]=<cfqueryparam value="#j.DATA[1][4]#" null="#LEN(j.DATA[1][4]) eq 0#"/>
,[of_duedate]=<cfqueryparam value="#j.DATA[1][5]#" null="#LEN(j.DATA[1][5]) eq 0#"/>
,[of_esttime]=<cfqueryparam value="#j.DATA[1][6]#" null="#LEN(j.DATA[1][6]) eq 0#"/>
,[of_extensioncompleted]=<cfqueryparam value="#j.DATA[1][7]#" null="#LEN(j.DATA[1][7]) eq 0#"/>
,[of_extensiondeadline]=<cfqueryparam value="#j.DATA[1][8]#" null="#LEN(j.DATA[1][8]) eq 0#"/>
,[of_fees]=<cfqueryparam value="#j.DATA[1][9]#" null="#LEN(j.DATA[1][9]) eq 0#"/>
,[of_filingdeadline]=<cfqueryparam value="#j.DATA[1][10]#" null="#LEN(j.DATA[1][10]) eq 0#"/>
,[of_form]=<cfqueryparam value="#j.DATA[1][11]#" null="#LEN(j.DATA[1][11]) eq 0#"/>
