...
<div><label for="g1_year"><i class="fa fa-lock link" onClick="_schk('g1_year')"></i> Year</label><select id="g1_year" disabled="disable"><option value="0">&nbsp;</option><cfoutput query="global_years"><cfif optionvalue_id neq year(now())><option value="#optionvalue_id#">#optionname#</option><cfelse><option value="#optionvalue_id#" selected="selected">#optionname#</option></cfif></cfoutput></select></div>
...
<div><label for="g1_g1_estimatedtime">Estimated Time</label><input type="text" placeholder="0" maxlength="6" id="g1_g1_estimatedtime" ></div>
</div>
...
<div><label for="g1_g2_estimatedtime">Estimated Time</label><input type="text" placeholder="0" maxlength="6" id="g1_g2_estimatedtime" ></div>
</div>
...
<div><label for="g1_g3_estimatedtime">Estimated Time</label><input type="text" placeholder="0" maxlength="6" id="g1_g3_estimatedtime" ></div>
</div>
...
<div><label for="g1_g4_estimatedtime">Estimated Time</label><input type="text" placeholder="0" maxlength="6" id="g1_g4_estimatedtime" ></div>
</div>
...
<div><label for="g1_g5_estimatedtime">Estimated Time</label><input type="text" placeholder="0" maxlength="6" id="g1_g5_estimatedtime" ></div>
</div>
</div>
