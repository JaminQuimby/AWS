...
_grid1=function(){_jGrid({
	...
	"fields":{PC_ID:{key:true,list:false,edit:false},CLIENT_NAME:{title:'Client Name'},PC_YEAR:{title:'Year'},PC_DATEDUE:{title:'Due Date'},PC_MISSINGINFO:{title:'Missing Information'}},
	"method":"f_lookupData",
