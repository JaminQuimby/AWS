...
<!---Subgroup 1--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_1","page":"payrolltaxes"});$("#isLoaded_group1_1").val(1);'>Obtain Info</h4>
<div>
...
<!---Subgroup 2--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_2","page":"payrolltaxes"});$("#isLoaded_group1_2").val(1);'>Entry</h4>
<div>
...
<!---Subgroup 3--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_3","page":"payrolltaxes"});$("#isLoaded_group1_3").val(1);'>Reconciliation</h4>
<div>
...
<!---Subgroup 4--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_4","page":"payrolltaxes"});$("#isLoaded_group1_4").val(1);'>Review</h4>
<div>
...
<!---Subgroup 5--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_5","page":"payrolltaxes"});$("#isLoaded_group1_5").val(1);'>Assembly</h4>
<div>
...
<!---Subgroup 6--->
<h4 onClick='_loadData({"id":"pt_id","group":"group1_6","page":"payrolltaxes"});$("#isLoaded_group1_6").val(1);'>Delivery</h4>
<div>
