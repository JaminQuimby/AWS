...
<div><label for="g1_taxyear"><i class="fa fa-lock link"></i> Year</label><select  id="g1_taxyear" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_years"><cfif optionvalue_id neq year(now())><option value="#optionvalue_id#">#optionname#</option><cfelse><option value="#optionvalue_id#" selected="selected">#optionname#</option></cfif></cfoutput></select></div>
<div><label for="g1_period"><i class="fa fa-lock link" ></i> Period</label><select id="g1_period" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_month"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
<div><label for="g1_state"><i class="fa fa-lock link"></i> State</label><select id="g1_state" disabled="disabled" onChange="_loadSelect({'selectName':'global_otherfilingsforms','selectObject':'g1_form','option1':$('#g1_state').val(),'page':'otherfilings'});"><option value="0">&nbsp;</option><cfoutput query="global_state"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
<div><label for="g1_type"><i class="fa fa-lock link"></i> Type</label><select id="g1_type" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_otherfilingtype"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
...
<div><label for="g1_fees">Fees</label><input type="text" placeholder="0" maxlength="10" id="g1_fees"></div>
