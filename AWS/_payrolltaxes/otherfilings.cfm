...
<cfquery dbtype="query" name="global_otherfilingsforms">SELECT[optionvalue_id],[optionname],[optionDescription]FROM[selectOptions]WHERE[selectName]='global_otherfilingsforms'</cfquery>
...
<div class="buttonbox">
<a href="#" class="button optional" onClick='document.getElementById("content").className="contentbig";_toggle("group1,largeMenu");_loadit({"query":{"COLUMNS":["G1_STATUS"],"DATA":[[4]]},"list":"g1_status","page":"otherfilings"});_hide("entrance,smallMenu");_addNewTask();'>Add</a></div></div></div>
<!--- FIELD DATA --->
...
<div><label for="g1_state"><i class="fa fa-lock link" onClick="_schk('g1_state')"></i> State</label><select id="g1_state" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_state"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
...
<div><label for="g1_form"><i class="fa fa-lock link" onClick="_schk('g1_form')"></i> Form</label><select id="g1_form" disabled="disabled"><option value="0">&nbsp;</option><cfoutput query="global_otherfilingsforms"><option value="#optionvalue_id#">#optionname#</option></cfoutput></select></div>
...
<div><label for="g1_fees">Fees</label><input type="text" placeholder="0" id="g1_fees" class="valid_off" onblur="jqValid({'type':'numeric','object':this,'message':'This field must be a number.'});"></div>
...
<!---Subgroup 2--->
<h4 onClick='_loadData({"id":"task_id","group":"group1_2","page":"otherfilings"});$("#isLoaded_group1_2").val(1);'>Preparation | <span id="g1_g2_head1"></span> | <span id="g1_g2_head2"></span></h4>
<div>
...
<!---Subgroup 3--->
<h4 onClick='_loadData({"id":"task_id","group":"group1_3","page":"otherfilings"});$("#isLoaded_group1_3").val(1);'>Review | <span id="g1_g3_head1"></span> | <span id="g1_g3_head2"></span></h4>
<div>
...
<!---Subgroup 4--->
<h4 onClick='_loadData({"id":"task_id","group":"group1_4","page":"otherfilings"});$("#isLoaded_group1_4").val(1);'>Assembly | <span id="g1_g4_head1"></span> | <span id="g1_g4_head2"></span></h4>
<div>
...
<!---Subgroup 5--->
<h4 onClick='_loadData({"id":"task_id","group":"group1_5","page":"otherfilings"});$("#isLoaded_group1_5").val(1);'>Delivery | <span id="g1_g5_head1"></span> | <span id="g1_g5_head2"></span></h4>
<div>
