...
_grid1_1=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"'+$("#g1_g1_filter").val()+'","orderBy":"0","row":"0","ID":"0","loadType":"group1_1","clientid":'+$("#cl_id").val()+'}',
	"functions":'$("#cl_fieldid").val(record.field_id);_loadData({"id":"cl_fieldid","group":"group1_1","page":"clientmaintenance"});$("#client").accordion({active:2});'
	});}
...
_grid3=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"'+$("#g3_filter").val()+'","orderBy":"0","row":"0","ID":"0","loadType":"group3","clientid":'+$("#cl_id").val()+'}',
	"functions":'$("#co_id").val(record.contact_id);_loadData({"id":"co_id","group":"group3","page":"clientmaintenance"});$("#contacts").accordion({active:1});'
	});}
...
_grid4_1=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"","orderBy":"0","row":"0","ID":'+$("#cl_id").val()+',"loadType":"group4_1"}',
...
_grid4_2=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"","orderBy":"0","row":"0","ID":'+$("#cl_id").val()+',"loadType":"group4_2"}',
...
_grid6=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"'+$("#g6_filter").val()+'","orderBy":"0","row":"0","ID":"0","loadType":"group6","clientid":'+$("#cl_id").val()+'}',
	"functions":'$("#si_id").val(record.SI_ID);_loadData({"id":"si_id","group":"group6","page":"clientmaintenance"});$("#State Information").accordion({active:1});'
	});}
...
_grid7=function(){_jGrid({
	...
	"method":"f_lookupData",
	"arguments":'{"search":"'+$("#g7_filter").val()+'","orderBy":"0","row":"0","ID":"'+$("#g7_group").val()+'","loadType":"group7","clientid":'+$("#cl_id").val()+'}',
	"functions":'_loadData({"id":"cl_id","group":"group7","page":"clientmaintenance"});$("#Related Clients").accordion({active:1});'
	});}
...
/*Group 1_2*/case "FIELD_ID":var list="cl_fieldid,g1_g1_fieldname,g1_g1_fieldvalue";_loadit({"query":query,"list":list});break;
