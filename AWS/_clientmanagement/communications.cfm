...
<div class="buttonbox">
<a href="#" class="button optional" onClick="document.getElementById('content').className='contentbig';_toggle('group1,largeMenu');_hide('entrance,smallMenu');_addNewTask();$('#g1_date').datetimepicker('setDate', (new Date()) );">Add</a>
</div></div></div>
<!--- FIELD DATA --->
