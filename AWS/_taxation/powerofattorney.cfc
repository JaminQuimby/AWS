...
<cfset queryResult=queryResult&'{"PA_ID":"'&PA_ID&'","CLIENT_ID":"'&CLIENT_ID&'","CLIENT_NAME":"'&CLIENT_NAME&'","PA_TAXYEARS":"'&PA_TAXYEARS&'"}'>
...
,[pa_preparers]=<cfqueryparam value="#j.DATA[1][6]#"/>
,[pa_status]=<cfqueryparam value="#j.DATA[1][7]#"/>
