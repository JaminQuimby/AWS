...
_loadAssets=function(){_loadData({"id":"client_id","group":"assetCreditHold","page":"financialtaxplanning"});_loadData({"id":"task_id","group":"assetCompTask","page":"financialtaxplanning"});}
