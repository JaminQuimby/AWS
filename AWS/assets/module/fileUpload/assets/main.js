...
require.config({
	...
	paths: {
		...
		jquery: "http://code.jquery.com/jquery-1.8.0",
...
require(
	...
	function( $, Uploader ){
		...
		var uploader = new Uploader( 
			$( "div.uploader" ),
			"https://cj.qutera.com/AWS/assets/module/fileUpload/uploadFiles.cfm",
			"https://cj.qutera.com/AWS/assets/module/fileUpload/assets/plupload/js/plupload.flash.swf"
		);
