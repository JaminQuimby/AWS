...
<link rel="stylesheet" id="size-stylesheet"  media='screen and (min-width: 1000px)'  href="#Application.url#/AWS/assets/module/menu/menu.css"/>
<link rel='stylesheet' media='screen and (max-width: 1000px)'  href="#Application.url#/AWS/assets/module/menu/menusmall.css" />

<cfswitch expression="#page.module#">
<cfcase value="_accountingservices"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/blue/jtable.min.css"></cfcase>
<cfcase value="_clientmanagement"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/green/jtable.min.css"></cfcase>
<cfcase value="_payrolltaxes"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/red/jtable.min.css"></cfcase>
<cfcase value="_payrolltaxes_report"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/red/jtable.min.css"></cfcase>
<cfcase value="_practicemanagement"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/darkgray/jtable.min.css"></cfcase>
<cfcase value="_taxation"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/darkorange/jtable.min.css"></cfcase>
<cfdefaultcase><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/module/jtable/themes/metro/darkgray/jtable.min.css"></cfdefaultcase>
</cfswitch>
...
<cfcase value="report"><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/css/report.css"/></cfcase>
<cfdefaultcase><link rel="stylesheet" type="text/css" href="#Application.url#/AWS/assets/css/aws.css"/></cfdefaultcase>
</cfswitch>
...
function adjustStyle(width) {
    ...
    if (width < 701) {
        $("##size-stylesheet").attr("href", "#Application.url#/AWS/assets/module/menu/menusmall.css");
    } else if ((width >= 701) && (width < 900)) {
        $("##size-stylesheet").attr("href", "#Application.url#/AWS/assets/module/menu/menu.css");
    } else {
       $("##size-stylesheet").attr("href", "#Application.url#/AWS/assets/module/menu/menu.css"); 
    }
}
