...
switch(params){
<cfloop index="i" list="#session.user.plugins#">
<cfif !ListContains(#page.plugins.disable#,#i#)>
case"group#i#":
_pluginURL#i#();break;
</cfif>
</cfloop>
...
_pluginLoadData=function(params){switch(params){<cfloop index="i" list="#session.user.plugins#"><cfif !ListContains(#page.plugins.disable#,#i#)>

case"group#i#": _pluginLoadData#i#(); break; 
