...
_grid4=function(){_jGrid({
	...
	"functions":'window.open(window.location.protocol+"//"+window.location.hostname+"/AWS/_accountingservices/businessFormation.cfm?task_id="?task_id="+record.BF_ID,\'WIPPOP\')'
})};
