...
_grid6=function(){_jGrid({
	...
	"fields":{FDS_ID:{key:true,list:false,edit:false}
			...
			,FDS_FEES:{title:'Fees',width:'1%'}
			,FDS_PAIDTEXT:{title:'Payment Status',width:'1%'}
			},
	"method":"f_lookupData",
...
_grid8=function(){_jGrid({
	...
	"fields":{N_ID:{key:true,list:false,edit:false}
			...
			,NST_STATUSTEXT:{title:'Status',width:'1%'}
			,NST_MISSINGINFO:{title:'Missing Information',width:'1%'}
			,NST_1_DATENOTICEREC:{title:'Date Notice Received',width:'1%'}
			,NST_1_RESDUEDATE:{title:'Response Due Date',width:'1%'}
			,NST_2_RESSUBMITED:{title:'Response Submited',width:'1%'}
			,NST_2_REVREQUIRED:{title:'Review Required',width:'1%'}			
			,NST_FEES:{title:'Fees'}
