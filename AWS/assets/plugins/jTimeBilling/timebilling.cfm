...
_grid102=function(){
	...
	"functions":'$("##tb_id").val(record.TB_ID);$("##isLoaded_group102").val(1);_loadData({"id":"tb_id","group":"group102","page":"timebilling","plugin":"group102"});$("##group102").accordion({active:1});'
	})};
...
_grid102_1=function(){
	...
	"fields":{T_ID:{key:true,list:false,edit:false}
			,T_START:{title:'Start Time'}
			,T_STOP:{title:'End Time'}
			},
	"method":"f_lookupData",
	"arguments":'{"search":"'+$("##g102_1_filter").val()+'","orderBy":"0","row":"0","formid":"#page.formid#","clientid":"'+$("##client_id").val()+'","taskid":"'+$("##task_id").val()+'","loadType":"group102_1"}',
	"functions":''
	})};
...
<div id="group102" class="gf-checkbox" >
	...
	<div>
        ...
        <div><label for="g102_rate">Rate</label><input type="text" class="readonly" id="g102_rate" ></div>
        <div><label for="g102_totaltime">Total Time</label><input type="text" class="readonly time" id="g102_totaltime" ></div>
        <div><label for="g102_subtotal">Subtotal</label><input type="text" class="readonly" id="g102_subtotal" ></div>       
...
<!---<div id="group102_1" class="gf-checkbox" >
